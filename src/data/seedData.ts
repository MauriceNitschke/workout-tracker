...
export function getInitialSeedState(): AppState {
  ...
  pushSubscriptions: [],
    ...
    preferences: {
      ...
      preWorkoutReminderMinutes: 60,
      quietHoursStart: '22:00',
      quietHoursEnd: '07:00',
      weeklyBodyweightReminderEnabled: true,
      weeklyBodyweightReminderDay: 1,
      weeklyBodyweightReminderTime: '08:00',
      missedWorkoutPromptEnabled: true,
    },
    enduranceActivities,
    recoveryActivities,
